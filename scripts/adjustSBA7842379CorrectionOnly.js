...
const CONFIG = {
  ...
  badTransactionId: '69d7dd236f8fd69827fd53c1',
  previousCorrectionId: '6a3c019685abc4d058bd5158',
  badAmount: -7020000,
  correctIncomeForBadRecord: 130000,
};
...
const main = async () => {
  ...
  console.log('SBA7842379 correction adjusted to target only the bad transaction.');
...
main().catch(async (error) => {
  console.error('SBA7842379 correction adjustment failed:', error.message);
  try {
    await mongoose.disconnect();
