...
const { staffAuth, customerAuth } = require('../../Middleware/index');
...
router.post('/process-automatic-payments', staffAuth, EcommerceOrderController.processAutomaticPayments);
...
router.put('/:id/status', staffAuth, EcommerceOrderController.updateOrderStatus);
router.post('/:id/installment-payment', staffAuth, EcommerceOrderController.recordInstallmentPayment);
router.post('/:id/payment', staffAuth, EcommerceOrderController.recordOutrightPayment);
router.post('/:id/credit-sb-account', staffAuth, EcommerceOrderController.creditSBAccount);
router.post('/:id/cancel', staffAuth, EcommerceOrderController.cancelOrder);
